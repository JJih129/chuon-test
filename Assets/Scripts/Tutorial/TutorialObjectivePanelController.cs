...
public class TutorialObjectivePanelController : MonoBehaviour
{
    ...
    [Header("Style")]
    [SerializeField] private Vector2 iconAnchoredPosition = new Vector2(26f, -24f);
    [SerializeField] private Vector2 iconSize = new Vector2(40f, 40f);
    [SerializeField] private Vector2 categoryAnchoredPosition = new Vector2(82f, -20f);
    [SerializeField] private Vector2 counterAnchoredPosition = new Vector2(-30f, -20f);
    [SerializeField] private Vector2 badgeAnchoredPosition = new Vector2(-220f, -18f);
    [SerializeField] private Vector2 badgeSize = new Vector2(146f, 30f);
    [SerializeField] private Vector2 titleAnchoredPosition = new Vector2(82f, -62f);
    [SerializeField] private Vector2 titleSize = new Vector2(640f, 40f);
    [SerializeField] private Vector2 statusAnchoredPosition = new Vector2(82f, -112f);
    [SerializeField] private Vector2 statusSize = new Vector2(640f, 60f);
    [SerializeField] private Vector2 progressAnchoredMin = new Vector2(30f, 16f);
    [SerializeField] private Vector2 progressAnchoredMax = new Vector2(-30f, 42f);
    [SerializeField] private float categoryFontSize = 24f;
    [SerializeField] private float titleFontSize = 28f;
    [SerializeField] private float counterFontSize = 24f;
